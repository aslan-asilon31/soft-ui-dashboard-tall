                    ...
                    <div class="flex flex-wrap -mx-3">
                        <div class="max-w-full px-3 lg:w-1/2 lg:flex-none">
                            <div class="flex flex-col h-full">
                                <p class="pt-2 mb-1 font-semibold">Hai !</p>
                                <h5 class="font-bold"> {{ Auth::user()->name }} </h5>
                                <p class="mb-12">You are login as </p>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td
                                        ...
                                        <span class="font-semibold leading-tight text-size-xs"> Rp14,000 </span>
                                    </td>
                                    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="p-2 leading-normal text-center align-middle bg-transparent border-b text-size-sm whitespace-nowrap">
                                        <span class="font-semibold leading-tight text-size-xs"> Rp3,000 </span>
                                    </td>
                                    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                        <div class="w-3/4 mx-auto">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="p-2 leading-normal text-center align-middle bg-transparent border-b text-size-sm whitespace-nowrap">
                                        <span class="font-semibold leading-tight text-size-xs"> Rp20,500 </span>
                                    </td>
                                    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                        <div class="w-3/4 mx-auto">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="p-2 leading-normal text-center align-middle bg-transparent border-b text-size-sm whitespace-nowrap">
                                        <span class="font-semibold leading-tight text-size-xs"> Rp500 </span>
                                    </td>
                                    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                        <div class="w-3/4 mx-auto">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td
                                        ...
                                        <span class="font-semibold leading-tight text-size-xs"> Rp2,000 </span>
                                    </td>
                                    <td class="p-2 align-middle bg-transparent border-0 whitespace-nowrap">
                                        <div class="w-3/4 mx-auto">
                                            <div>
                    ...
                    <div
                        ...
                        <div class="relative mb-4 mt-0 after:clear-both after:table after:content-['']">
                            ...
                            <div class="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                                <h6 class="mb-0 font-semibold leading-normal text-size-sm text-slate-700">Rp2400,
                                    Design changes</h6>
